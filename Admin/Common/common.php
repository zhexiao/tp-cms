 ...
 */ 
function create_verify($width='80',$height='30',$num='4',$interferon='80',$line='2',$verify_name='verify'){
	$code = strtoupper( substr(md5(rand(0, 100)), 0, $num) );
	$_SESSION[$verify_name] = $code;
	
	//生成图片
	$im = imagecreate($width, $height);
	imagecolorallocate( $im, rand(50, 70), rand(150, 200), rand(230, 250) );
